...
import PanelFilmProject from './panelFilmProject';
...
export default function OldFilms() {
  return (
    <ProjectLayout>
      <StyledSubheader>COMING SOON</StyledSubheader>

      {/* <PanelFilmProject
          im_path={'/film-stills/Honors/MSILWV-yellow.png'}
      ...
      <StyledProjectsContainer>
        ...
        <FilmProject
          ...
          description='Flashing lights explode across an apartment as images of a woman in bed
                      flicker in and out. A stop motion of light paintings and projections'
